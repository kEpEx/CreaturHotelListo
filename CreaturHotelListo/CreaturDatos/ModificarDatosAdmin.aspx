<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarDatosAdmin.aspx.cs" Inherits="CreaturDatos.ModificarDatosAdmin" %>
...
<body>
   <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Modificar hoteles</h1>
    ...
    <div>
        ...
        <form runat="server">
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCreaturHotelConnectionString3 %>" SelectCommand="SELECT * FROM [tblDatos]"></asp:SqlDataSource>
            <div id="usoAdmin">
                <%--Titulo de admin--%>
                ...
                <div id="facEfectiva">
                    ...
                    <asp:DropDownList ID="cmbFacEfectivo" runat="server" style="padding-left:10px; position:absolute; top:120px; left:76px;">
            ...
            <div id="usoAgentes">
                ...
                <div id="nomAgen">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCreaturHotelConnectionString3 %>" SelectCommand="SELECT [Nombre] FROM [tblUsuarios]">
                    </asp:SqlDataSource>
                </div>
                ...
                <div id="numNoches">
                    ...
                    <asp:TextBox ID="tbTariBasImpuesInclud" runat="server" style="width:140px; position:absolute; top:383px; left:460px;" ></asp:TextBox>
            ...
            <div id="usoCali">
                ...
                <div id="numRechTarjetas">
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" runat="server" FilterType="Numbers" TargetControlID="tbNumTarRech"/>
                </div>
            ...
            <div id="DivBtn" style="position:absolute; left:648px; top:1750px;">
                <asp:Button ID="btnModificar" runat="server" Text="Button" OnClick="btnModificar_Click" />
                <asp:TextBox ID="tbIdModificar" runat="server" Visible="False"></asp:TextBox>
            </div>

            <asp:SqlDataSource ID="SqlDataSource3" runat="server"  ConnectionString="<%$ ConnectionStrings:DBCreaturHotelConnectionString3 %>"
                UpdateCommand= "UPDATE [tblDatos] SET [FacturaProveedor]=@facturaProveedor, [ObservacionesAdministracion]=@observacionesAdministracion,
                 ...
                 <SelectParameters>
                     <asp:ControlParameter ControlID="tbFactProveedor" Name="facturaProveedor" PropertyName="Text"  Type="String" ConvertEmptyStringToNull="False"/>        
                 </SelectParameters>
            </asp:SqlDataSource>
