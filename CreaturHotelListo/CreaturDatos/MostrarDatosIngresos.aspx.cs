...
{
    public partial class MostrarDatosIngresos : System.Web.UI.Page
    {
        ...
        protected void gvDatosIngresos_RowDataBound(object sender, GridViewRowEventArgs e)
        {

        }

        protected void gvDatosIngreso_SelectedIndexChanged(object sender, EventArgs e)
        {
            GridViewRow gvDatAd = gvDatosIngreso.SelectedRow;
            ...
            Response.Redirect("AgregarDatosIngresos.aspx");
        }
    }
}