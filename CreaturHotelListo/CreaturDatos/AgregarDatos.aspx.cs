...
namespace CreaturDatos
{
    ...
    public partial class AgregarDatos : System.Web.UI.Page
    {
        ...
        {
            string from = "jcordero@vsabtc.com";
            string pass = "pepesan91";
            //string to = "pepesan91@hotmail.com";
            string mensaje = "Esto solo es un mensaje de prueba";
            new Email().EnviarCorreo(from, pass, mensaje);
        }


        protected void tbTotConImpInclud_TextChanged(object sender, EventArgs e)
        {

            tbTotConImpInclud.Text = tbNoche.Text;
            //int numNoches = Convert.ToInt32(tbNoche.Text);
            //double tarifa = Convert.ToDouble(tbTariBasImpuesInclud.Text);

            //tbTotConImpInclud.Text = (numNoches + tarifa).ToString();
        }

        protected void tbTariBasImpuesInclud_TextChanged(object sender, EventArgs e)
        {
            //int valor1 = Convert.ToInt32(tbNoche.Text);
            //double valor2 = Convert.ToDouble(tbTariBasImpuesInclud.Text);
            ...
            //DateTime d2 = Convert.ToDateTime(tbFechaCheOut.Text);
            //TimeSpan ds = d2 - d1;
            //tbNoche.Text = Convert.ToString(ds);
        }
    }
}