<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDatosIngresos.aspx.cs" Inherits="CreaturDatos.MostrarDatosIngresos" %>
...
<meta name="viewport" content="initial-scale=1, maximum-scale=1"/>
    <title>Mostrar Datos Ingresos</title>
    <link rel="stylesheet" type="text/css" href="css/Normalize.css" />
    <link rel="stylesheet" type="text/css" href="css/MostrarIngresos.css"/>
...
<body>
    ...
    <header>
        <h1>Mostrar Hoteles Ingresos</h1>
    </header>
    </div>
    ...
    <form  runat="server">
        ...
        <div id="contFiltros">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/btnLogout.png" style="position:absolute; top:-224px; width:60px; height:60px; left:1242px;" OnClick="imgBtnHome_Click"/>
            <asp:Label ID="Label1" runat="server" Text="Cerrar Sesión" style="position:absolute; top:-160px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            font-size:12px; color:white; left:1236px;" ></asp:Label>

                <asp:Label ID="lblBuscar" runat="server" Text="Buscar huesped:" style="font-family:'Segoe UI'; font-size:20px;
                color:#71C4FF; position:absolute; top:16px; left:285px; width:144px;"></asp:Label>
                <asp:Label ID="lblAgenteAdmin" runat="server" Text="Buscar agente:" style="font-family:'Segoe UI'; font-size:20px;
                color:#71C4FF; position:absolute; top:71px; left:300px; width:144px;"></asp:Label>
                ...
                <asp:TextBox ID="tbBuscarHuesped" runat="server" style="position:absolute; top:20px; left:440px;"></asp:TextBox>
                <asp:TextBox ID="tbBuscarAgente" runat="server" style="position:absolute; top:75px; left:440px;" ></asp:TextBox>
                ...
                <asp:ImageButton ID="ImgbtnFiltrarFecha" CssClass="botonRedondo" style="height:60px; width:60px;
                margin-left:30px; position:absolute; top:28px; left:1191px;"  runat="server" ImageUrl="~/img/calendarImg.png"/>

                <asp:Label ID="lblDel" runat="server" Text="Del" style="font-family:'Segoe UI'; font-size:20px;
                color:#71C4FF; position:absolute; top:46px; left:745px;" ></asp:Label>

                <asp:TextBox ID="tbFecha1" runat="server" CssClass="datepicker" style="position:absolute;  top:49px; left:779px;"></asp:TextBox>

                <asp:Label ID="lblFecha1" runat="server" Text="Al" style="font-family:'Segoe UI'; font-size:20px;
                color:#71C4FF; position:absolute; top:46px; left:983px;" ></asp:Label>

                <asp:TextBox ID="tbFecha2" runat="server" CssClass="datepicker" style="position:absolute; top:49px; left:1010px;" >31/08/2015</asp:TextBox>
            </div>
        
        <div id="tablaResult">
              <strong>
              <asp:GridView ID="gvDatosIngreso" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#000066" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSourceCreaturModel" Width="8481px" AllowSorting="True" PageSize="5" Height="100px" OnSelectedIndexChanged="gvDatosIngreso_SelectedIndexChanged">
                <Columns>
...
<HeaderStyle CssClass="colorDireccion"></HeaderStyle>
             ...
             UpdateCommand= "UPDATE [tblDatos] SET [NumFacturaCreatur]=@NumFacturaCreatur, [ObservacionIngreso]=@ObservacionIngreso WHERE [Id]=@id"
                 ...
                 <SelectParameters>
                     ...
                     <asp:ControlParameter ControlID="tbFecha1" Name="fecha1" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False"/>
                     <asp:ControlParameter ControlID="tbFecha2" Name="fecha2" PropertyName="Text" Type="String" ConvertEmptyStringToNull="False"/>
                 </SelectParameters>
