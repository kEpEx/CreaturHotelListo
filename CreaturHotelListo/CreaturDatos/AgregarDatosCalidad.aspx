<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarDatosCalidad.aspx.cs" Inherits="CreaturDatos.AgregarDatosCalidad" %>
...
<meta name="viewport" content="initial-scale=1, maximum-scale=1"/>
    <title>Modificar hotel calidad</title>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Modificar hotel calidad</h1>
    ...
    <div>
        ...
        <form runat="server">
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <div id="usoAdmin">
                <%--Titulo de admin--%>
                <asp:Label ID="lblAdmin" runat="server" Text="Admin" style="font-size:30px; font-weight:800; padding-left:20px; position:absolute;"></asp:Label>
                <%--Contenedor de factura efectiva--%>
                <div id="facEfectiva">
                    <asp:Label ID="lblFacEf" runat="server" Text="Factura efectiva: " style="position:absolute; top:54px; left:50px;"></asp:Label>
