<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarDatosIngresos.aspx.cs" Inherits="CreaturDatos.AgregarDatosIngresos" %>
...
<meta name="viewport" content="initial-scale=1, maximum-scale=1"/>
    <title>Agregar hoteles ingresos</title>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Modificar hotel Ingresos</h1>
    ...
    <div>
        ...
        <form runat="server">
            ...
            <asp:ImageButton ID="imgBtnHome" runat="server" ImageUrl="~/img/homebtn.png" style="position:absolute; top:7px; width:60px; height:60px; left:1177px;" OnClick="imgBtnHome_Click"/>
            <asp:Label ID="lblHome" runat="server" Text="Inicio" style="position:absolute; top:71px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <div id="usoAdmin">
                ...
                <div id="facEfectiva">
                    ...
                    <asp:DropDownList ID="cmbFacEfectivo" runat="server" style="left:80px; top:120px; position:absolute;">
