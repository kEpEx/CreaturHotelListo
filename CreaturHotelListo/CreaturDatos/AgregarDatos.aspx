<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarDatos.aspx.cs" Inherits="CreaturDatos.AgregarDatos" %>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Agregar Hoteles</h1>
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <div id="usoAgentes">
                ...
                <div id="nomAgen">
                    ...
                    <asp:TextBox ID="tbFechaCreacion" CssClass="datepicker" runat="server" style="position:absolute; left:460px; width: 140px;" ReadOnly="True"></asp:TextBox>
                ...
                <div id="numNoches">
                    ...
                    <asp:TextBox ID="tbTariBasImpuesInclud" runat="server" style="width:140px; position:absolute; top:383px; left:460px;" OnTextChanged="tbTariBasImpuesInclud_TextChanged" >0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="tbTariBasImpuesInclud"/>
                    ...
                    <asp:TextBox ID="tbTotConImpInclud" runat="server" style="width: 140px; position:absolute; left:750px; top:383px;" ReadOnly="True" OnTextChanged="tbTotConImpInclud_TextChanged">0</asp:TextBox>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Numbers" TargetControlID="tbTotTarifHotel"/>
                </div>
                ...
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" FilterType="Numbers" TargetControlID="tbPorcenGanSobTotalImpuInclud"/>
                ...
                <div id="serAdicio">
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterType="Numbers" TargetControlID="tbPorGananSerAdici"/>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Numbers" TargetControlID="tbImporteServAdicionales"/>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" FilterType="Numbers" TargetControlID="tbCargoServicio"/>
                </div>
                ...
                <div id="imporGanancia">
                    ...
                    <asp:TextBox ID="tbImporGanan" runat="server" style="width: 140px; top:710px; left:164px; position:absolute;" ReadOnly="True">0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server" FilterType="Numbers" TargetControlID="tbImporGanan"/>
                    ...
                    <asp:TextBox ID="tbTotFactuHospedaje" runat="server" ReadOnly="true" style="width:140px; position:absolute; top:710px; left:460px;" >0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" FilterType="Numbers" TargetControlID="tbTotFactuHospedaje"/>
