<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarAgentes.aspx.cs" Inherits="CreaturDatos.ModificarAgentes"%>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Modificar hotel Agentes</h1>
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <div id="usoAdmin">
                ...
                <div id="facEfectiva">
                    ...
                    <asp:DropDownList ID="cmbFacEfectivo" runat="server" style="padding-left:10px; position:absolute; top:120px; left:75px;">
            ...
            <div id="usoAgentes">
                ...
                <div id="nomAgen">
                    <asp:Label ID="lblNombreAgente" runat="server" Text="Nombre agente: " style="position:absolute; left:100px;"></asp:Label>
                
                    <asp:Label ID="lblFechCre" runat="server" Text="Fecha de </br> creación: " style="position:absolute; left:380px; top:57px;" CssClass="auto-style1"></asp:Label>
                    <asp:TextBox ID="tbFechaCreacion"  runat="server" style="position:absolute; left:460px; width: 140px;" ReadOnly="True"></asp:TextBox>
                    ...
                    <asp:DropDownList ID="cmbNomAgentes" runat="server" DataSourceID="SqlDataSource2" DataTextField="Nombre" DataValueField="Nombre" style="position:absolute; left:162px; top:70px;">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCreaturHotelConnectionString3 %>" SelectCommand="SELECT [Nombre] FROM [tblUsuarios] WHERE ([TipoUsuario] = @TipoUsuario)">
                        <SelectParameters>
              ...
              <div id="gkDiv">
                ...
                <div id="numNoches">
                    ...
                    <asp:TextBox ID="tbNoche" runat="server" style="width: 140px; position:absolute; left:162px; top:383px;" CssClass="auto-style1" ReadOnly="True">0</asp:TextBox>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom, Numbers" ValidChars=".," TargetControlID="tbTariBasImpuesInclud"/>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Custom, Numbers" ValidChars=".,"  TargetControlID="tbTotTarifHotel"/>
                </div>
                ...
                <div id="ishDiv">
                    ...
                    <asp:TextBox ID="tbPorcenGanSobTotalImpuInclud" runat="server" style="width: 140px; position:absolute; top:490px; left:164px; " MaxLength="5">0</asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" FilterType="Custom, Numbers" ValidChars=".," TargetControlID="tbPorcenGanSobTotalImpuInclud"/>
                    ...
                    <asp:TextBox ID="tbImporteGanancia" runat="server" style="width: 140px; position:absolute; left:1000px; top:490px;" ReadOnly="True">0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" runat="server" FilterType="Custom, Numbers" ValidChars=".,"  TargetControlID="tbImporteGanancia"/>
                ...
                <div id="serAdicio">
                    ...
                    <asp:TextBox ID="tbPorGananSerAdici" runat="server" style="width:140px ; position:absolute; top:600px; left:460px;" MaxLength="5">0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterType="Custom, Numbers" ValidChars=".,"  TargetControlID="tbPorGananSerAdici"/>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Custom, Numbers" ValidChars=".," TargetControlID="tbImporteServAdicionales"/>
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" FilterType="Custom, Numbers" ValidChars=".," TargetControlID="tbCargoServicio"/>
                </div>
                ...
                <div id="imporGanancia">
                    ...
                    <asp:TextBox ID="tbImporGanan" runat="server" style="width: 140px; top:710px; left:164px; position:absolute;" ReadOnly="True" CssClass="auto-style1">0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server" FilterType="Custom, Numbers" ValidChars=".," TargetControlID="tbImporGanan"/>
                    ...
                    <asp:TextBox ID="tbTotFactuHospedaje" runat="server" style="width:140px; position:absolute; top:710px; left:460px;" ReadOnly="True" >0</asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" FilterType="Custom, Numbers" ValidChars=".," TargetControlID="tbTotFactuHospedaje"/>
            ...
            <div id="usoDireccionGen">
                <%--Titulo de admin--%>
                <asp:Label ID="lblDirecc" runat="server" Text="Dirección General" style="font-size:30px; font-weight:800; padding-left:52px;"></asp:Label>
                <%--Contenedor de factura efectiva--%>
                <div id="resEfectiva">
                 ...
                 <div id="fopFin">
                    ...
                    <asp:Label ID="lblObserDirec" runat="server" Text="Observaciones: " style="padding-left:14px;"></asp:Label>
            ...
            <div id="DivBtn">
                <asp:Button ID="btnEnviar" runat="server" Text="Guardar cambios" OnClick="btnEnviar_Click" style="margin-top:480px; margin-left:500px;" BackColor="#0066FF" Font-Bold="True" ForeColor="White" Height="100px" Width="300px" />
                <asp:Button ID="btnGenerarBoletoAgente" runat="server" Text="Generar Boleto" style="position:absolute; top:480px; margin-left:825px;" BackColor="Orange" Font-Bold="True" ForeColor="White" Height="100px" Width="300px" OnClick="btnGenerarBoletoAgente_Click" />
