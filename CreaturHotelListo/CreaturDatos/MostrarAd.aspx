<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarAd.aspx.cs" Inherits="CreaturDatos.MostrarAd" %>
...
<body>
    ...
    <form  runat="server">
        ...
        <div id="contFiltros">
            <asp:ImageButton ID="imgBtnHomeDirec" runat="server" ImageUrl="~/img/btnLogout.png" style="position:absolute; top:-224px; width:60px; height:60px; left:1186px;" OnClick="imgBtnHome_Click"/>
            ...
            font-size:12px; color:white; left:1182px;" ></asp:Label>
                ...
                <asp:Label ID="lblFiltrarFechaDirec" runat="server" Text="Filtrar fecha de creación" style="font-family:'Segoe UI'; font-size:20px;
                color:#71C4FF; font-weight:600; position:absolute; top:0px; left:763px; width:218px;"></asp:Label>
                ...
                <asp:TextBox ID="tbFecha1Direc" runat="server" CssClass="datepicker" style="position:absolute; top:49px; left:784px;"></asp:TextBox>
        ...
        <div id="tablaResult">
              <strong>
             <asp:GridView ID="gvDatosAdmiiin" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#000066" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSourceCreaturModel" Width="8481px" AllowSorting="True" PageSize="100" Height="100px" OnSelectedIndexChanged="gvDatosAdmiiin_SelectedIndexChanged">
                <Columns>
