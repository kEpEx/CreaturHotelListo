<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdAgentes.aspx.cs" Inherits="CreaturDatos.AdAgentes"%>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Agregar Datos Agentes</h1>
    ...
    <div>
        ...
        <form runat="server">
            ...
            <div id="usoAgentes" style="margin-top:-350px;">
                ...
                <div id="nomAgen">
                    ...
                    <asp:TextBox ID="tbNomAgentes" runat="server" style="position:absolute; left:162px; top:70px; width:140px;"></asp:TextBox>
            ...
            <div id="DivBtn">
                <asp:Button ID="btnEnviar" runat="server" Text="Enviar" style="margin-top:50px; margin-left:672px;" BackColor="#0066FF" Font-Bold="True" ForeColor="White" Height="100px" Width="300px" OnClick="btnEnviar_Click1" />
    ...
    <div id="footAgreDatos" style="margin-top:1361px;">
        <footer>
