<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarDatosAdministracion.aspx.cs" Inherits="CreaturDatos.AgregarDatosAdministracion" %>
...
<meta name="viewport" content="initial-scale=1, maximum-scale=1"/>
    <title>Modificar hotel administracion</title>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Modificar Hotel Admon</h1>
    ...
    <div>
        ...
        <form runat="server">
            ...
            <asp:ImageButton ID="imgBtnHome" runat="server" ImageUrl="~/img/homebtn.png" style="position:absolute; top:8px; width:60px; height:60px; left:1219px;" OnClick="imgBtnHome_Click"/>
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <div id="usoAgentes">
                ...
                <div id="ishDiv">
                    ...
                    <asp:TextBox ID="tbISH" runat="server" style="width: 140px; position:absolute; left:750px; top:490px;"></asp:TextBox>
