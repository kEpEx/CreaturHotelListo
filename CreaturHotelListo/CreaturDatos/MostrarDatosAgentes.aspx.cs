...
{
    public partial class MostrarDatosAgentes : System.Web.UI.Page
    {
        ...
        protected void gvDatosAgentes_SelectedIndexChanged(object sender, EventArgs e)
        {
            GridViewRow gvDatAd = gvDatosAgentes.SelectedRow;
            ...
            Response.Redirect("ModificarAgentes.aspx");
        }
