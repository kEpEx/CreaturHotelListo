...
{
    public partial class MostrarAd : System.Web.UI.Page
    {
        ...
        protected void gvDatosAdmiiin_SelectedIndexChanged(object sender, EventArgs e)
        {
            GridViewRow gvDatAd = gvDatosAdmiiin.SelectedRow;
            ...
            Response.Redirect("AgregarDatosAd.aspx");
        }
    }
}