<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDatosAgentes.aspx.cs" Inherits="CreaturDatos.MostrarDatosAgentes" %>
...
<meta name="viewport" content="initial-scale=1, maximum-scale=1"/>
    <title>Mostrar Datos Admin</title>
    <link rel="stylesheet" type="text/css" href="css/Normalize.css" />
    <link rel="stylesheet" type="text/css" href="css/MosDatosAgente.css"/>
...
<body>
    ...
    <form  runat="server">
        ...
        <div id="contFiltros" style="background:#808080;">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/homebtn.png" style="position:absolute; top:-224px; width:60px; height:60px; left:1220px;" OnClick="imgBtnHome_Click"/>
            <asp:Label ID="Label1" runat="server" Text="Inicio" style="position:absolute; top:-160px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            font-size:12px; color:white; left:1236px;" ></asp:Label>
                ...
                <asp:TextBox ID="tbFecha1" runat="server" CssClass="datepicker" style="position:absolute;  top:49px; left:779px;" placeholder="Coloca una fecha"></asp:TextBox>
        ...
        <div id="tablaResult">
              <strong>
              <asp:GridView ID="gvDatosAgentes" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#000066" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSourceCreaturModel" Width="10000px" AllowSorting="True" Height="100px" OnSelectedIndexChanged="gvDatosAgentes_SelectedIndexChanged">
                <Columns>
                    <asp:CommandField SelectText="Editar/Generar cupon" ShowSelectButton="True" />
...
<HeaderStyle CssClass="colorDireccion"></HeaderStyle>
                ...
                [TotalFacHospedaje]=@totalFacHospedaje, [FormaPago]=@formaPago, [TipoTarifa]=@tipoTarifa  WHERE [Id]=@id">
