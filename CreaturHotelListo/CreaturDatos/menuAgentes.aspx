<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuAgentes.aspx.cs" Inherits="CreaturDatos.menuAgentes" %>
...
<body>
    ...
    <div id="btnAgregarAdministracion">
        ...
        <asp:ImageButton ID="imgCerrarSesionMenuAgentes" runat="server" ImageUrl="~/img/btnLogout.png" style="position:absolute; top:20px; width:60px; height:60px; left:1202px;" OnClick="imgCerrarSesionMenuAgentes_Click" />
        <asp:Label ID="LblCerrarMenuAgentes" runat="server" Text="Cerrar Sesión" style="position:absolute; top:83px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
