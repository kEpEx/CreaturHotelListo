...
{
    public partial class MostrarDatosCalidad : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //tbFecha2Cal.Text = fechaFinal.ToShortDateString();
        }
        ...
        protected void gvDatosCal_SelectedIndexChanged(object sender, EventArgs e)
        {
            GridViewRow gvDatAd = gvdC.SelectedRow;
            ...
            Response.Redirect("AgregarDatosCalidad.aspx");
        }
