<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDatosAdministracion.aspx.cs" Inherits="CreaturDatos.MostrarDatosAdministracion" %>
...
<body>
    ...
    <form  runat="server">
         ...
         <div id="contFiltros" style="background:#808080;">
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/btnLogout.png" style="position:absolute; top:-224px; width:60px; height:60px; left:1241px;" OnClick="imgBtnHome_Click"/>
            ...
            font-size:12px; color:white; left:1237px;" ></asp:Label>
                ...
                <asp:TextBox ID="tbFecha2" runat="server" CssClass="datepicker" style="position:absolute; top:49px; left:1010px;" >08/31/2015</asp:TextBox>
        ...
        <div id="tablaResult">
            ...
            <asp:GridView ID="gvDatosAdmon" runat="server" AutoGenerateColumns="False" HeaderStyle-CssClass="FixedHeader" DataKeyNames="Id" DataSourceID="SqlDataSource1" Height="100px" Width="10000px" PageSize="100"  OnSelectedIndexChanged="gvDatosAdmon_SelectedIndexChanged1">
                 <Columns>
