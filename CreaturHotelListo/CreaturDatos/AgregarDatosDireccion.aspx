<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarDatosDireccion.aspx.cs" Inherits="CreaturDatos.AgregarDatosDireccion" %>
...
<meta name="viewport" content="initial-scale=1, maximum-scale=1"/>
    <title>Agregar hoteles direccion</title>
...
<body>
    ...
    <header id="HeaderDatos">
        ...
        <h1 style="font-size:84px; color:white; margin-top:108px;">Modificiar hotel Dirección Gral.</h1>
           ...
           <%--Contenedor que almacena los datos de administración--%>
            ...
            <div id="usoAdmin">
                ...
                <div id="facEfectiva">
                    ...
                    <asp:DropDownList ID="cmbFacEfectivo" runat="server" style="left:82px; position:absolute; top:120px;">
