<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuAdministracion.aspx.cs" Inherits="CreaturDatos.menuAdministracion" %>
...
<body>
    ...
    <div id="btnAgregarAdministracion">
        ...
        <asp:ImageButton ID="imgCerrarSesionMenuAdmon" runat="server" ImageUrl="~/img/btnLogout.png" style="position:absolute; top:20px; width:60px; height:60px; left:1202px;" OnClick="imgCerrarSesionMenuAdmon_Click" />
